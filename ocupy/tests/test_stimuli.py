...
class TestStimuli(unittest.TestCase):
    ...
    def test_fixations(self):
        img_per_cat = {7:list(range(1,65)),8:list(range(1,65))}
    ...
    def test_general(self):
        ...
        # Let's check this
        self.assertTrue(7 in inp.categories())
        self.assertTrue(8 in inp.categories())
        self.assertEqual(len(inp[7].images()), 64)
        self.assertEqual(len(inp[8].images()), 64)
